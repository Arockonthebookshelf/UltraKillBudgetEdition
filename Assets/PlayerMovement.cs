...
//    //Private Floats
//    private float wallRunGravity = 100f;
...
//            return;
//        }
//        if ((Mathf.Abs(mag.x) > num2 && Mathf.Abs(x) < 0.05f) || (mag.x < 0f - num2 && x > 0f) || (mag.x > num2 && x < 0f))
//        {
//            rb.AddForce(moveSpeed * orientation.transform.right * Time.deltaTime * (0f - mag.x) * num);
//        }
//        if ((Mathf.Abs(mag.y) > num2 && Mathf.Abs(y) < 0.05f) || (mag.y < 0f - num2 && y > 0f) || (mag.y > num2 && y < 0f))
//        {
...
//        return new Vector2(y: magnitude * Mathf.Cos(num * ((float)Mathf.PI / 180f)), x: magnitude * Mathf.Cos(num2 * ((float)Mathf.PI / 180f)));
//    }
...
//        if (Mathf.Abs(wallNormalVector.x - 1f) < 0.1f)
//        {
//            num = 90f;
//        }
//        else if (Mathf.Abs(wallNormalVector.x - -1f) < 0.1f)
//        {
//            num = 270f;
//        }
//        else if (Mathf.Abs(wallNormalVector.z - 1f) < 0.1f)
//        {
//            num = 0f;
//        }
//        else if (Mathf.Abs(wallNormalVector.z - -1f) < 0.1f)
